PyAdminAddOutage MATLAB Python Package
...
2. Installing the PyAdminAddOutage Package

A. Change to the directory that contains the file setup.py and the subdirectory 
PyAdminAddOutage. If you do not have write permissions, copy all its contents to a 
...
3. Using the PyAdminAddOutage Package

The PyAdminAddOutage package is on your Python path. To import it into a Python script or 
session, execute:

    import PyAdminAddOutage
